...
export const Terminal = () => {
	...
	return (
		<div className="relative bg-black text-neon font-mono text-base p-8 leading-relaxed border border-neon rounded-4xl shadow-neon overflow-hidden pipboy-terminal">
			...
			<ReactLenis root>
				<div
					className="h-[75%] overflow-auto pr-2 scrollbar-thin scrollbar-thumb-neon scrollbar-track-transparent"
